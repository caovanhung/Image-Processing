...
class Ui_Trend_Edge_width_Dialog(object):
    def setupUi(self, Trend_Edge_width_Dialog):
      ...
      #  self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        ...
        self.Trend_Edge_width_tableWidget.setColumnCount(3)
        self.Trend_Edge_width_tableWidget.setRowCount(1)
        ...
        self.Trend_Edge_width_SAVE_pushButton.clicked.connect(self.change_save)
        self.Trend_Edge_width_RESET_pushButton.clicked.connect(self.change_Reset)

        self.timer = QTimer()
        self.timer.timeout.connect(self.Trend_Edge_width_viewCam)
        self.Trend_Edge_width_RUN_pushButton.clicked.connect(self.Trend_Edge_width_controlTimer)
   ...
   #     print(self.file_img)
    ...
    def Change_point(self):
       ...
       #  self.point_2=self.Trend_Edge_width_Point_2_spinBox.value()-1
         ...
         self.coordinate=self.Trend_Edge_width_Coordinate_comboBox.currentText()
         img_1=cv2.imread(self.file_img,1)
         if self.ten_position_1=="Max" or self.ten_position_1=="Min":
              self.Trend_Edge_width_Point_1_spinBox.setEnabled(0)
         if self.ten_position_1=="Middle":
              self.Trend_Edge_width_Point_1_spinBox.setEnabled(1)
     
         #print(self.ten_position_1)
         L_max_min,length_tt,self.img_xuly=self.Trend_Edge_width_threshold_img.divid_point(self.Value_shift,self.point_1,self.Trend_direction,self.coordinate,self.Scan_direction,self.ten_position_1,img_1)     
        # print(self.img_xuly)
         self.Trend_Edge_width_tableWidget.setItem(0,1, QTableWidgetItem(str(L_max_min)))
    ...
    def Change_middle_point(self):
      ...
      #   print(self.ten_position_1)
         length_point_ponint,self.img_xuly=self.Trend_Edge_width_threshold_img.divid_middle_point(self.Value_shift,self.point_1,self.Trend_direction,self.coordinate,self.Scan_direction,self.ten_position_1,img_1)     
        # print(self.img_xuly)
         self.Trend_Edge_width_tableWidget.setItem(0,1, QTableWidgetItem(str(length_point_ponint)))
         height, width,channel = self.img_xuly.shape
         step =  width*channel
         qImg = QImage(self.img_xuly.data, width, height, step, QImage.Format_RGB888)
         pixmap = QPixmap.fromImage(qImg)
    ...
    def change_save(self):
       ...
       #  self.point_2=self.Trend_Edge_width_Point_2_spinBox.value()-1
         ...
         if self.ten_position_1=="Max" or self.ten_position_1=="Min":
              #self.Trend_Edge_width_Point_1_spinBox.setEnabled(0)
              self.L_max_min,length_tt,self.img_xuly=self.Trend_Edge_width_threshold_img.divid_point(self.Value_shift,self.point_1,self.Trend_direction,self.coordinate,self.Scan_direction,self.ten_position_1,img_1)
              self.Trend_Edge_width_tableWidget.setItem(0,1, QTableWidgetItem(str(L_max_min)))
         if self.ten_position_1=="Middle":
              #self.Trend_Edge_width_Point_1_spinBox.setEnabled(1)

              self.length_point_ponint,self.img_xuly=self.Trend_Edge_width_threshold_img.divid_middle_point(self.Value_shift,self.point_1,self.Trend_direction,self.coordinate,self.Scan_direction,self.ten_position_1,img_1)
              self.Trend_Edge_width_tableWidget.setItem(0,1, QTableWidgetItem(str(self.length_point_ponint)))
      #   print(self.ten_position_1)
      #   length_point_ponint,self.img_xuly=self.Trend_Edge_width_threshold_img.divid_middle_point(self.Value_shift,self.point_1,self.Trend_direction,self.coordinate,self.Scan_direction,self.ten_position_1,img_1)     
        # print(self.img_xuly)
         self.Trend_Edge_width_SAVE_pushButton.setEnabled(0)
         self.Trend_Edge_width_RESET_pushButton.setEnabled(0)
    ...
    def change_Reset(self):
         self.Trend_Edge_width_SAVE_pushButton.setEnabled(1)
         self.Trend_Edge_width_RESET_pushButton.setEnabled(0)
         


    def Trend_Edge_width_controlTimer(self):
        # if timer is stopped
        print("da chay")
        if not self.timer.isActive():
            ...
            # start timer
            self.timer.start(20)
            self.Trend_Edge_width_RUN_pushButton.setText("Stop")
        else:
            self.Trend_Edge_width_RUN_pushButton.setText("RUN")
            #self.Threshold_comboBox.setEnabled(1)

    def Trend_Edge_width_viewCam(self):
    #    if  self.x00 and self.x10 and self.y00 and self.y10 : 
        ...
        # Access the image data
            ...
            #print(self.img.shape)
               ...
               self.image_1  = cv2.cvtColor(self.img, cv2.COLOR_BGR2RGB )
     
               height, width,channel = self.image_1.shape
               step =  width*channel
               qImg = QImage(self.image_1.data, width, height, step, QImage.Format_RGB888)
               pixmap = QPixmap.fromImage(qImg)
               self.img_Trend_Edge_width_label.setPixmap(QPixmap.fromImage(qImg))
