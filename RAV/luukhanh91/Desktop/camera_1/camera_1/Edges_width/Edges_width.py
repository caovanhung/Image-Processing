...
class Ui_Edges_width_Dialog(object):
    def setupUi(self, Edges_width_Dialog):
       ...
       # self.scrollArea.setWidget(self.scrollAreaWidgetContents)
        ...
        self.Edges_width_tableWidget.setColumnCount(3)
        self.Edges_width_tableWidget.setRowCount(1)
        ...
        self.horizontalLayoutWidget_5.setGeometry(QtCore.QRect(0, 410, 331, 31))
        ...
        self.horizontalLayoutWidget_9.setGeometry(QtCore.QRect(0, 450, 331, 41))
        ...
        self.Edge_width_Edge_1_spinBox.valueChanged.connect(self.display_edges)
        self.Edge_width_Edge_2spinBox.valueChanged.connect(self.display_edges)
        self.Edges_width_Position_comboBox.currentIndexChanged.connect(self.change_position)

        #self.Edges_width_SAVE_pushButton.clicked.connect(self.find_counter)
        self.Edges_width_Sensitivity_horizontalSlider.valueChanged.connect(self.find_counter)
    ...
    def retranslateUi(self, Edges_width_Dialog):
        ...
        self.Edges_width_Position_comboBox.setItemText(0, _translate("Edges_width_Dialog", "Line"))
        self.Edges_width_Position_comboBox.setItemText(1, _translate("Edges_width_Dialog", "Point"))
        self.Edges_width_Position_comboBox.setItemText(2, _translate("Edges_width_Dialog", "Point_Line"))
    ...
    def find_counter(self):
         ...
         self.number_pixel_value=self.Edges_width_number_pixel_spinBox.value()
         self.Edge_threshold_value=self.Edge_width_threshold_spinBox.value()
         self.Edge_sen_value=self.Edges_width_Sensitivity_horizontalSlider.value()
         self.ten_truc=self.Edges_width_DERECTION_comboBox.currentText()
       #  self.img_xuly=self.img_edges_width.edges_count(img_1)
         

         

         value_Edge_1,value_Edge_2,self.img_xuly=self.img_edges_width.edges_count_1(img_1,self.ten_truc,self.number_pixel_value,self.Edge_threshold_value,self.Edge_sen_value)
         self.Edge_width_Edge_1_spinBox.setRange(1,value_Edge_1)
         self.Edge_width_Edge_2spinBox.setRange(1,value_Edge_2) 
    ...
    def change_position(self):
         ...
         img_1=cv2.imread(self.file_img,1)
         cv2.rectangle(img_1,(self.x00,self.y00),(self.x10,self.y10),(0,255,0),3)
         value_Edge_1=self.Edge_width_Edge_1_spinBox.value()
         value_Edge_2=self.Edge_width_Edge_2spinBox.value()
         self.ten_truc=self.Edges_width_DERECTION_comboBox.currentText()
         self.name_position=self.Edges_width_Position_comboBox.currentText()
         value_Edge_1,value_Edge_2=self.img_edges_width.position_line(img_1,self.name_position,self.ten_truc)
         self.Edge_width_Edge_1_spinBox.setRange(1,value_Edge_1)
         self.Edge_width_Edge_2spinBox.setRange(1,value_Edge_2) 
    ...
    def display_edges(self):
         ...
         if self.name_position=="Line":
              self.length_length,self.img_xuly=self.img_edges_width.length_line_line(img_1,value_Edge_1-1,value_Edge_2-1,self.ten_truc,self.name_position)
         if self.name_position=="Point":
              self.length_length,self.img_xuly=self.img_edges_width.length_point_point(img_1,value_Edge_1-1,value_Edge_2-1,self.ten_truc,self.name_position)
         if self.name_position=="Point_Line":
              self.length_length,self.img_xuly=self.img_edges_width.display_value(img_1,value_Edge_1-1,value_Edge_2-1,self.ten_truc)
        # self.img_xuly=self.img_edges_width.length_line_line(img_1,value_Edge_1-1,value_Edge_2-1,self.ten_truc,self.name_position)
         #self.img_xuly=self.img_edges_width.length_point_point(img_1,value_Edge_1-1,value_Edge_2-1,self.ten_truc,self.name_position)
         self.Edges_width_tableWidget.setItem(0,1, QTableWidgetItem(str(self.length_length)))
